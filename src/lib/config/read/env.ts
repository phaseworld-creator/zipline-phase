...
export const ENVS = [
  ...
  env('features.publicUploadPortal', 'FEATURES_PUBLIC_UPLOAD_PORTAL', 'boolean', true),
  env('features.oneTimeShareLinks', 'FEATURES_ONE_TIME_SHARE_LINKS', 'boolean', true),
  env('features.soundboard', 'FEATURES_SOUNDBOARD', 'boolean', true),
  env('features.advancedAnalytics', 'FEATURES_ADVANCED_ANALYTICS', 'boolean', true),
  env('features.watermark.enabled', 'FEATURES_WATERMARK_ENABLED', 'boolean', true),
  env('features.watermark.text', 'FEATURES_WATERMARK_TEXT', 'string', true),
  env('features.watermark.image', 'FEATURES_WATERMARK_IMAGE', 'string', true),
  env('features.watermark.position', 'FEATURES_WATERMARK_POSITION', 'string', true),
  env('features.watermark.opacity', 'FEATURES_WATERMARK_OPACITY', 'number', true),
