...
export const DATABASE_TO_PROP = {
  ...
  featuresPublicUploadPortal: 'features.publicUploadPortal',
  featuresOneTimeShareLinks: 'features.oneTimeShareLinks',
  featuresSoundboard: 'features.soundboard',
  featuresAdvancedAnalytics: 'features.advancedAnalytics',
  featuresWatermarkEnabled: 'features.watermark.enabled',
  featuresWatermarkText: 'features.watermark.text',
  featuresWatermarkImage: 'features.watermark.image',
  featuresWatermarkPosition: 'features.watermark.position',
  featuresWatermarkOpacity: 'features.watermark.opacity',
